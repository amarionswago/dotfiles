return {
	...
	init = function()
		local group = vim.api.nvim_create_augroup("user-obsidian-markdown", { clear = true })
		...
		vim.api.nvim_create_autocmd("FileType", {
			...
			callback = function(args)
				...
				require("user.core.obsidian").setup_markdown_buffer(args.buf)
			end,
		})
	end,
	opts = function()
		return require("user.core.obsidian").opts()
	end,
	config = function(_, opts)
		require("obsidian").setup(opts)
		require("user.core.obsidian").patch_template_substitutions()
	end,
}
