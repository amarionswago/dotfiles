return {
	...
	config = function()
		...
		local has_rndr, rndr = pcall(require, "rndr")
		...
		telescope.setup({
			defaults = {
				buffer_previewer_maker = defaults.buffer_previewer_maker,
				file_ignore_patterns = defaults.file_ignore_patterns,
				path_display = defaults.path_display,
